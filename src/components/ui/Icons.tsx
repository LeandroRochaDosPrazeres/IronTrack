...
export const DumbbellIcon: React.FC<IconProps> = ({ size = 24, className }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className={className}>
        <path d="M6.5 6.5a2.5 2.5 0 0 1 0 5H4.5a2.5 2.5 0 0 1 0-5h2z" />
        <path d="M17.5 6.5a2.5 2.5 0 0 1 0 5h2a2.5 2.5 0 0 1 0-5h-2z" />
        <path d="M6.5 12.5a2.5 2.5 0 0 0 0 5H4.5a2.5 2.5 0 0 0 0-5h2z" />
        <path d="M17.5 12.5a2.5 2.5 0 0 0 0 5h2a2.5 2.5 0 0 0 0-5h-2z" />
...
export const FireIcon: React.FC<IconProps> = ({ size = 24, className }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path d="M12 23c-4.97 0-9-3.58-9-8 0-3.19 2.09-6.41 6-9.24-.38 1.69-.08 3.88 1.08 5.43.67.89 1.64 1.42 2.55 1.76-.16-.77-.23-1.79.11-2.85.46-1.38 1.47-2.51 2.74-3.18-.09.98.27 2.15.94 2.84.66.68 1.58 1.05 2.08 1.96.47.85.55 2.1 0 3.1-.45.81-1.07 1.33-1.55 2-.96 1.34-1.12 3.18-.4 4.63.39.79 1.01 1.33 1.45 2.08-1.39.44-2.87.47-4.28.47z" />
    </svg>
)
...
export const MoreVerticalIcon: React.FC<IconProps> = ({ size = 24, className }) => (
    <svg width={size} height={size} viewBox="0 0 24 24" fill="currentColor" className={className}>
